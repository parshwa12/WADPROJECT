...
<body>
	...
	<center>
		<div class="w3-card-4" style="width: 70%; background: rgb(255,255,255); opacity: 0.95;">
			<header class="w3-container w3-blue">
			<h3>Municipal</h3>
			</header>
			<p>In this section, the customers can file their complains and
		...
		<div class="w3-card-4" style="width: 70%; background: rgb(255,255,255); opacity: 0.9;">
			<header class="w3-container w3-blue">
			<h3>Education</h3>
			</header>
			<p>In this section, the customers will be very helpful in getting
		...
		<div class="w3-card-4" style="width: 70%; background: rgb(255,255,255); opacity: 0.9;">
			...
			<p>Here, the customer's rail transportation issues will be
